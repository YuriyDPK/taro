...
export function AuthProviderSelector({
  ...
  const handleTelegramAuth = () => {
    // Не закрываем dropdown, показываем Telegram Login Widget
    showTelegramLoginWidget();
  };

  const handleGoogleAuth = () => {
    // Не закрываем dropdown, идем на Google
    signIn("google");
  };
  ...
  return (
    <div className={`relative inline-block ${className}`} ref={dropdownRef}>
      <Button
        ...
        size="default"
        className="bg-black/60 border border-purple-400/50 text-white hover:bg-purple-600/30 hover:border-purple-400 font-medium px-6 py-2 text-base transition-all flex items-center gap-2"
      >
        👤 Войти
        <svg
      ...
      {isOpen && (
        <>
          {/* Desktop dropdown */}
          <div className="hidden md:block absolute top-full left-0 mt-2 w-56 bg-black/90 backdrop-blur-sm border border-purple-400/30 rounded-lg shadow-lg z-50">
            <div className="p-2 space-y-2">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-white/60">Через telegram</div>
                </div>
              </button>
            </div>
          </div>
          ...
          {/* Mobile modal */}
          <div className="md:hidden fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="relative bg-black/90 border border-purple-400/30 rounded-lg p-6 max-w-sm w-full mx-4">
              <button
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-4 py-4 text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg transition-colors flex items-center gap-3"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-4 text-white bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg transition-colors flex items-center gap-3"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
